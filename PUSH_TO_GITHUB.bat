...
title Push NUMBER-BOTMAN Bot to GitHub
cls
echo ========================================================
echo   PUSH NUMBER-BOTMAN TO GITHUB (BOT FILES ONLY)
echo ========================================================
echo.
set "REPO_URL=https://github.com/HimelKhan006/NUMBER-BOTMAN.git"
...
git commit -m "Update bot - zero-restart handover engine, stock sync & Gist persistence" >nul 2>&1
git branch -M main
